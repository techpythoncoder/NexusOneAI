...
from notification_service.core.database import Base, get_db
...
# Mock email sending to avoid real SMTP hits
@pytest.fixture(autouse=True)
def mock_email():
    with mock.patch("notification_service.services.email_service.send_email", new_callable=mock.AsyncMock) as mock_send:
        yield mock_send
