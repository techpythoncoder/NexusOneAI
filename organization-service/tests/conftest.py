...
from organization_service.core.database import Base, get_db
...
def mock_kafka():
    ...
    with mock.patch("organization_service.core.kafka.get_producer", return_value=mock_prod) as mock_get:
        yield mock_get
